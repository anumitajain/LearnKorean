...
mode = "Start Page"  #different modes so different code chunks are used
#-----------------------------------------------
#>>>>>>> b37069600e70d21e3f7ffd73c2510bd6e86204ef
blueArrowPic = image.load("blueArrow.png")
...
while running:
    ...
    mx, my = mouse.get_pos()
    if mode == "Start Page":
        draw.rect(screen, (0, 0, 255), beginnerRect)
        if beginnerRect.collidepoint(mx,my) and click:
            mode = "Beginner"
